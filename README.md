## Advanced Exercises
The following _project_ consists of various _exercises_ that cover advanced use cases when using [HashiCorp's Terraform](https://www.terraform.io/) to automate [Alkira Infrastructure.](https://www.alkira.com/)
